...
const Produto = ({ game }: Props) => {
  const dispatch = useDispatch() // hook para disparar ações //* dispatch é uma função que envia ações para a store
  ...
  return (
    <S.Produto>
      ...
      <S.BtnComprar onClick={() => dispatch(adicionarItem(game))} type="button">
